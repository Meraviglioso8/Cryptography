...
int main(int argc, char* argv[])
{
    ...
    // Specify the output filename with the ".png" extension
    std::string outputFilename = "D:/exported_UIT.png";

    // Write the binary data to the output file
    std::ofstream outputFile(outputFilename, std::ios::binary);
    outputFile.write(message_bin.data(), message_bin.size());
    outputFile.close();
    std::cout << "Exported the message as PNG: " << outputFilename << std::endl;
